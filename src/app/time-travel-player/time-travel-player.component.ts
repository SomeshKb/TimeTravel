...
@Component({
  selector: 'time-travel-player',
  templateUrl: './time-travel-player.component.html',
  styleUrls: ['./time-travel-player.component.scss']
})
export class TimeTravelPlayerComponent implements OnInit {
