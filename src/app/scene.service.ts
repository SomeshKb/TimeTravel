...
import { OrbitControls } from 'src/assets/js/OrbitControlCustom/OrbitControlCustom';
import { OrbitControlsGizmo } from 'src/assets/js/OrbitControlsGizmo/OrbitControlsGizmo';
...
export class SceneService {
  ...
  axesHelper: AxesHelper | null = null;
